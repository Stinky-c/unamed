...
public class Config {
    ...
    private static final ModConfigSpec.BooleanValue LOG_DIRT_BLOCK = BUILDER.comment(
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends String>> ITEM_STRINGS = BUILDER.comment(
